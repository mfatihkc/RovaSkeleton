...
export class RovaInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {RovaMatchMediaService} _rovaMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _rovaMediaMatchService: RovaMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._rovaMediaMatchService.onMediaChange
