...
import { RovaPerfectScrollbarGeometry, RovaPerfectScrollbarPosition } from '@rova/directives/rova-perfect-scrollbar/rova-perfect-scrollbar.interfaces';
import { RovaConfigService } from '@rova/services/config.service';

@Directive({
    selector: '[rovaPerfectScrollbar]'
})
export class RovaPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set rovaPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get rovaPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.rovaPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.rovaPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): RovaPerfectScrollbarGeometry
    {
        return new RovaPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): RovaPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new RovaPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
