...
import { MatColors } from '@rova/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const FUSE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => RovaMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'rova-material-color-picker',
...
export class RovaMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, rova-navy-700 etc.)
