...
@Component({
    selector   : 'rova-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : rovaAnimations
})
export class RovaNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._rovaNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._rovaNavigationService.onItemCollapsed.next(this.item);
        this._rovaNavigationService.onItemCollapseToggled.next();
    }
