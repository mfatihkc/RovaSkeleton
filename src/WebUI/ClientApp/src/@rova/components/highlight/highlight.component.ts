...
import '@rova/components/highlight/prism-languages';

@Component({
    selector : 'rova-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class RovaHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using rova-highlight
        // component
