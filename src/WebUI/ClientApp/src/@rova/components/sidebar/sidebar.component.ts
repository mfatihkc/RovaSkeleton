...
import { RovaSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'rova-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class RovaSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._rovaConfigService.config
            ...
            .subscribe((config) => {
                this._rovaConfig = config;
            });

        // Register the sidebar
        this._rovaSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._rovaSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('rova-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('rova-sidebar-overlay-invisible');
        }
