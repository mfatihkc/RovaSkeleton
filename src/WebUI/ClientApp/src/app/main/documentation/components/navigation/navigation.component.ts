...
export class DocsComponentsNavigationComponent
{
    ...
    showHideCalendarMenuItem(): void
    {
        ...
        this._rovaNavigationService.updateNavigationItem('calendar', {
            hidden: this.hidden
        });
    }
    ...
    updateMailBadge(): void
    {
        ...
        this._rovaNavigationService.updateNavigationItem('mail', {
                badge: {
                    title: 35
                }
        });
    ...
    addNavItemWithCustomFunction(): void
    {
        ...
        this._rovaNavigationService.addNavigationItem(newNavItem, 'start');
    }
    ...
    {
        this._rovaNavigationService.removeNavigationItem('dashboards');
    }
    ...
    registerNewNavigationAndToggle(): void
    {
        ...
        this._rovaNavigationService.register('admin-nav', adminNav);

        // Set the current navigation
        this._rovaNavigationService.setCurrentNavigation('admin-nav');
    }
}
