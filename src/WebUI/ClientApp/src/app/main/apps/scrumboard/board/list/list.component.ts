...
export class ScrumboardBoardListComponent implements OnInit, OnDestroy
{
    ...
    @ViewChild(RovaPerfectScrollbarDirective)
    listScroll: RovaPerfectScrollbarDirective;

    confirmDialogRef: MatDialogRef<RovaConfirmDialogComponent>;
    ...
    {
        this.confirmDialogRef = this._matDialog.open(RovaConfirmDialogComponent, {
            disableClose: false
        });
