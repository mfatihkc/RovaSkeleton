import { RovaNavigation } from '@rova/types';

export const navigation: RovaNavigation[] = [
    {
        id       : 'applications',
        title    : 'Applications',
    ...
    },
    {
        ...
        children: [
            ...
            {
                id      : 'working-with-rova',
                title   : 'Working with Rova',
                type    : 'collapsable',
                icon    : 'import_contacts',
                children: [
                    {
                        ...
                        title: 'Server',
                        type : 'item',
                        url  : '/documentation/working-with-rova/server'
                    },
                    {
                        id   : 'production',
                        title: 'Production',
                        type : 'item',
                        url  : '/documentation/working-with-rova/production'
                    },
                    {
                        id   : 'directory-structure',
                        title: 'Directory Structure',
                        type : 'item',
                        url  : '/documentation/working-with-rova/directory-structure'
                    },
                    {
                        id   : 'updating-rova',
                        title: 'Updating Rova',
                        type : 'item',
                        url  : '/documentation/working-with-rova/updating-rova'
                    },
                    {
                        id   : 'multi-language',
                        title: 'Multi Language',
                        type : 'item',
                        url  : '/documentation/working-with-rova/multi-language'
                    },
                    {
                        id   : 'material-theming',
                        title: 'Material Theming',
                        type : 'item',
                        url  : '/documentation/working-with-rova/material-theming'
                    },
                    {
                        id   : 'theme-layouts',
                        title: 'Theme Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-rova/theme-layouts'
                    },
                    {
                        id   : 'page-layouts',
                        title: 'Page Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-rova/page-layouts'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'rovaIfOnDom',
                        type : 'item',
                        url  : '/documentation/directives/rova-if-on-dom'
                    },
                    {
                        id   : 'rova-inner-scroll',
                        title: 'rovaInnerScroll',
                        type : 'item',
                        url  : '/documentation/directives/rova-inner-scroll'
                    },
                    {
                        id   : 'rova-mat-sidenav',
                        title: 'rovaMatSidenav',
                        type : 'item',
                        url  : '/documentation/directives/rova-mat-sidenav'
                    },
                    {
                        id   : 'rova-perfect-scrollbar',
                        title: 'rovaPerfectScrollbar',
                        type : 'item',
                        url  : '/documentation/directives/rova-perfect-scrollbar'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'Rova Config',
                        type : 'item',
                        url  : '/documentation/services/rova-config'
                    },
                    {
                        id   : 'rova-splash-screen',
                        title: 'Rova Splash Screen',
                        type : 'item',
                        url  : '/documentation/services/rova-splash-screen'
                    }
                ]
            }
        ]
